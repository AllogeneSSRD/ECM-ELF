/* cgbn_stage1_kernels_param2_tpi16.cu -- param2 lookup for TPI=16 (2560..8192 tiers), split out of cgbn_stage1_kernels_param2.cu on 2026-09-25.
 *
...
cgbn_stage1_kernel_fn cgbn_stage1_kernel_param2_tpi16(uint32_t BITS, uint32_t *TPI_out) { (void)BITS; (void)TPI_out; return nullptr; }
